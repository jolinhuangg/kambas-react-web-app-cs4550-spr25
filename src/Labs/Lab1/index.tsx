export default function Lab1() {
    return (
        <div id="wd-lab1">
          ...
          <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                <li>Chop tomatoes, onions, and garlic.</li>
                <li>Mix 2 eggs.</li>
                <li>Stir fry the tomatoes, onions, and garlic.</li>
                <li>Remove from pan and scramble the egg mixture.</li>
                <li>Add the tomatoes back in and stir.</li>
                <li>Add in a tablespoon of oyster sauce and ketchup.</li>
                <li>Salt and pepper to taste.</li>
                <li>Serve over rice or enjoy on it's own.</li>
            </ol>
            ...
            <h5>Unordered List Tag</h5>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Red Rising</li>
                    <li>1986</li>
                    <li>To All The Boys I Loved Before</li>
                </ul>
        ...
        <div id="wd-forms">
            ...
            <a href="https://github.com/jolinhuangg/kambas-react-web-app-cs4550-spr25" id="wd-github">click here</a>
            to access my GitHub code repository.<br/>
